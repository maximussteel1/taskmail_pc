...
>
> 当前 canonical 路径：`docs/current/multi_question_protocol.md`
> 已归档旧来源文件：`docs/archive/multi_question_protocol_implementation_legacy.md`
...
- optional `Profile: <name>` and/or `Permission: <default|highest>` headers before the answer body

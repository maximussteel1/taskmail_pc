...
_SERVER_MESSAGE_TYPES = {"hello_ack", "error", "command_dispatch"}
_CLIENT_MESSAGE_TYPES = {"pc_hello", "heartbeat", "workspace_snapshot", "command_ack"}
...
PcControlClientMessage = PcHelloMessage | PcHeartbeatMessage | PcWorkspaceSnapshotMessage | PcCommandAckMessage
...
PcControlServerMessage = PcHelloAckMessage | PcErrorMessage | PcCommandDispatchMessage

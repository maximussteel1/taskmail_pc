"""Shared transport routing for backend adapters."""
...
class TransportRoutingAdapter(WorkerAdapter):
    """Selects the CLI or SDK transport for each task and remembers ownership for kill."""

...
MODULES = [
    ...
    "mail_runner.observe",
    "mail_runner.opencode_sdk_common",
    "mail_runner.models",
    "mail_runner.mail_io",
    ...
    "mail_runner.file_surface_consumer_smoke",
    "mail_runner.external_delivery",
    "mail_runner.external_delivery_index",
    "mail_runner.external_delivery_window",
    "mail_runner.health_semantics",
    "mail_runner.pc_control_live_smoke",
    "mail_runner.pc_control_live_multi_pc_smoke",
    "mail_runner.pc_control_live_roundtrip_smoke",
    "mail_runner.pc_control_live_support",
    "mail_runner.pc_control_operator_dispatch",
    "mail_runner.pc_control_operator_read",
    "mail_runner.parser",

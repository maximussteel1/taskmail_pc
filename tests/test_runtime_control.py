...
from mail_runner.app import _process_runtime_thread_kill_requests
...
from mail_runner.thread_store import create_thread


def _create_thread_state(task_root: Path, *, status: str, task_id: str = "task_001") -> None:
    create_thread(
